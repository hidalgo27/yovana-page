                    ...
                    <table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" align="center" width="600">
                        ...
                        <tr bgcolor="#ffffff">
                            <td valign="top" style="padding:10px 35px 0 35px;color:#ffffff">
                                <img class="CToWUd" width="350" alt="logo gotoperu" src="{{asset('images/logo-yovana.png')}}" style="vertical-align:top;max-width:220px">
                            </td>
...
{{--            <tr>--}}
{{--                <td>--}}
{{--                    <img class="CToWUd" width="250" alt="logo gotoperu" src="{{asset('images/logo-yovana.png')}}" style="vertical-align:top;max-width:220px">--}}
{{--                </td>--}}
{{--            </tr>--}}
{{--            </tbody>--}}
{{--        </table>--}}
